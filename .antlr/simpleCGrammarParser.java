...
public class simpleCGrammarParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, T__13=14, Integer=15, Double=16, 
		Char=17, String=18, Bool=19, Identifier=20, ArithmeticOperator=21, RelationalOperator=22, 
		LogicalOperator=23, AssignmentOperator=24, Keyword=25, LParen=26, RParen=27, 
		LBrace=28, RBrace=29, LBracket=30, RBracket=31, Comma=32, Semi=33, Colon=34, 
		LineComment=35, BlockComment=36, WS=37, LibraryName=38;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, "Integer", "Double", "Char", "String", "Bool", "Identifier", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1015888L) != 0)) {
				{
				setState(52);
				_errHandler.sync(this);
	...
	public final FuncBodyContext funcBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 337116800L) != 0)) {
				{
				setState(156);
				_errHandler.sync(this);
	...
	public final IterationStatementContext iterationStatement() throws RecognitionException {
		...
		try {
			...
			case T__9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68677632L) != 0)) {
					{
					setState(201);
					expr(0);
					}
	...
	public static class MTypeContext extends ParserRuleContext {
		...
		public TerminalNode Char() { return getToken(simpleCGrammarParser.Char, 0); }
		public TerminalNode String() { return getToken(simpleCGrammarParser.String, 0); }
		public TerminalNode Bool() { return getToken(simpleCGrammarParser.Bool, 0); }
